...
const DEFAULT_CONTENT = {
  global: {
    ...
    footerBlurb: "Axiotrix Global helps practices and businesses get found online, capture more enquiries, and cut the manual work out of their day."
  },

  home: {
    heroEyebrow: "Digital Solutions",
    heroTitle: "Your patients and clients are searching. We make sure they find you.",
    heroText: "Alongside our healthcare and financial services, Axiotrix now builds the digital side of your practice: the website that brings enquiries in, and the tools and automations that handle them for you.",
    ...
    servicesTitle: "Five things we can set up for your practice or business",
    servicesText: "Start with the one you need most. Each one fixes a real, everyday problem.",
    whyEyebrow: "Why it matters",
    whyTitle: "Your team should be serving clients, not doing repetitive admin",
    whyText: "Most offices lose hours every day answering the same questions, chasing paperwork and re-keying information between systems. We set up simple systems that do this work for you, so your team's time goes where it earns."
  },
  ...
  services: [
    {
      ...
      title: "When patients and clients search, they should find you",
      text: "People search online before they choose a provider. We build a fast, clear site that shows up in that search, reads as credible, and makes it one click to book or enquire.",
      heroNote: "Ready in days. Enquiries route straight to your team.",
      impact: "People who never knew about you start calling and booking.",
      problem: "Right now, someone nearby is searching for exactly what you offer. If you are hard to find, they book with the practice or firm that was easier to find, and you never know it happened.",
      usecases: [
        { t: "The practice patients cannot find", d: "A dental or medical practice relying on referrals gets a fast, clear site with services, insurances accepted and a book-appointment button, so a local search turns into a booked chair.",
          i: "New patients start finding the practice directly, instead of ending up at the clinic down the road." },
        { t: "The firm losing enquiries", d: "An accounting or consulting firm whose leads arrive by phone tag and scattered emails gets a site with a clear offer and an enquiry form that routes straight to the right person.",
          i: "Every enquiry is captured and answered, so more of the same traffic turns into signed clients." },
    ...
    },
    {
      ...
      text: "Estimates, client records, status tracking: if your team does it by hand every day, we can build a simple tool that does it for them. They review it, instead of producing it.",
      ...
      problem: "Hours disappear into spreadsheets, re-typing and chasing status. That is time your team could spend on clients. A small tool built around your exact workflow takes it off their plate.",
      usecases: [
        { t: "The instant quote or estimate tool", d: "A service business lets clients pick what they need and see an accurate price right away, then emails the estimate as a branded PDF, with no back-and-forth.",
          i: "Estimates go out in minutes instead of days, so clients decide while their interest is still high." },
        ...
        { t: "The client-facing portal", d: "Clients get a simple screen to upload documents, check status or update details, instead of emailing your team for every small thing.",
    ...
    },
    {
      ...
      text: "Revenue, appointments, outstanding balances, top referral sources: one simple screen, updated automatically. No spreadsheet wrangling, no month-end surprises.",
      ...
      usecases: [
        { t: "The daily practice snapshot", d: "An owner opens one link each morning and sees yesterday's appointments, collections, no-shows and outstanding claims, without waiting for a report to be built.",
        ...
        { t: "The marketing scorecard", d: "You see which channel actually produced paying clients, not just clicks, so the next dollar goes where it works.",
    ...
    },
    {
      ...
      impact: "Clients stop slipping away just because the office had a busy week.",
      ...
      usecases: [
        ...
        { t: "The appointment and renewal reminder", d: "Patients and clients are reminded before an appointment, a renewal or a filing deadline, without anyone working a list by hand.",
          i: "No-shows and lapsed renewals drop, and it costs nothing extra each month to keep it that way." },
        { t: "The behind-the-scenes hand-off", d: "A new intake form automatically creates the record, alerts the right team member, and confirms receipt with the client, all in the same moment.",
    ...
    },
    {
      ...
      text: "Clients text and message more than they call. We set up WhatsApp and SMS properly: one-tap contact buttons, instant replies to common questions, and every conversation logged where your team can see it.",
      ...
      problem: "Messages arrive across text, WhatsApp and voicemail, and live on whoever's phone received them. Then one gets buried, a client feels ignored, and nobody can tell what was promised.",
      usecases: [
        ...
        { t: "The instant auto-reply", d: "After hours or when the front desk is busy, an automatic reply answers common questions and captures the enquiry so none go cold.",
          i: "No enquiry dies overnight; every one gets an answer in seconds, even when the office is closed." },
        { t: "The message-to-record link", d: "A confirmed enquiry or appointment drops straight into your system, so nothing lives only in one person's chat thread.",
      ...
      steps: [
        { t: "Map the conversation", d: "We list the messages clients actually send you today." },
  ...
  about: {
    ...
    text: "Axiotrix Global already handles the revenue cycle and finances behind the scenes. This service extends that to the front: the site that brings enquiries in, and the tools and reminders that make sure none are dropped. Built once, then kept working.",
    values: [
  ...
  testimonials: [
    { quote: "Enquiries used to sit in three different inboxes. Now every one is logged and answered the same day.", name: "Practice Manager", role: "Multi-location dental group" },
    { quote: "The estimate tool paid for itself in a month. Clients get a number right away and we stopped rebuilding quotes by hand.", name: "Managing Partner", role: "Professional services firm" },
    { quote: "One dashboard, opened every morning. We finally know which referral sources actually bring paying clients.", name: "Operations Director", role: "Healthcare services company" }
  ],
  ...
  faq: [
    ...
    { q: "How does this fit with your healthcare and financial services?", a: "It is the same team and the same account. If Axiotrix already handles your revenue cycle or your books, this simply extends that to your website, client messaging and reporting." }
  ],

  submit: {
    eyebrow: "Tell us what you need",
    title: "Tell us about your practice or business. We will tell you what helps.",
